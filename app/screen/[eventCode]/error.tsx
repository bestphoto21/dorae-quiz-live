...
export default function ScreenError({ reset }: { reset: () => void }) {
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 p-8 text-white">
      <section className="w-full rounded-3xl bg-white p-12 text-center text-slate-950 shadow-2xl">
        ...
        <button
          type="button"
          onClick={reset}
          className="mt-10 min-h-14 rounded-2xl border border-slate-950 bg-slate-950 px-6 py-4 text-xl font-black text-white shadow-sm"
        >
          다시 시도
        </button>
      </section>
